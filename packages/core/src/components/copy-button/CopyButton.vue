...
export interface CopyButtonSlots {
   ...
   *
   * The label should let the user know the copy was successful when `isCopying` is `true` - unless you already provide feedback, in which case you should set `preventAnnouncement`.
   *
